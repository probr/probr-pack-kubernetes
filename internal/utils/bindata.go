...
func testFeaturesKubernetesPodsecuritypolicyFeaturesYamlPspAzpSeccompApprovedYaml() (*asset, error) {
	...
	info := bindataFileInfo{name: "test/features/kubernetes/podsecuritypolicy/features/yaml/psp-azp-seccomp-approved.yaml", size: 634, mode: os.FileMode(438), modTime: time.Unix(1598355883, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func testFeaturesKubernetesPodsecuritypolicyFeaturesYamlPspAzpVolumetypesApprovedYaml() (*asset, error) {
	...
	info := bindataFileInfo{name: "test/features/kubernetes/podsecuritypolicy/features/yaml/psp-azp-volumetypes-approved.yaml", size: 627, mode: os.FileMode(438), modTime: time.Unix(1598432325, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
